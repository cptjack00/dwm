...
const char *spcmd1[] = {TERMINAL, "-n", "spterm", "-g", "130x40", NULL };
...
static Key keys[] = {
	...
	{ MODKEY,		    XK_p,			spawn,		SHCMD("spotifyctl -q playpause") },
	{ MODKEY,			XK_bracketleft,		spawn,		SHCMD("spotifyctl -q previous") },
	{ MODKEY,			XK_bracketright,	spawn,		SHCMD("spotifyctl -q next") },
    ...
    { MODKEY,           XK_Escape,   spawn,         SHCMD("betterlockscreen -l dim") },
    { MODKEY,           XK_e,        spawn,         SHCMD("teams")},
